...
Original file is located at
    https://colab.research.google.com/drive/1BLd-6rcnzW0uTL466w-qlnl48Vf3C9Ob
...
def filtragem(img, window_size=5, coord1=(88,88), coord2=(170,170)):
  ...
  tamanho = 10
  espectro_fourier[coord1[0]-window_size : coord1[0]+window_size, coord1[1]-window_size : coord1[1]+window_size] = 0
  espectro_fourier[coord2[0]-window_size : coord2[0]+window_size, coord2[1]-window_size : coord2[1]+window_size] = 0
