...
public:
    ...
    */
    FlowExponential(string name, System *s, System *t): FlowImpl(name, s, t){};
...
public:
    /*!
        ...
        \param name nome do fluxo.
    */
    FlowLogistic(string name, System *s, System *t): FlowImpl(name, s, t){};
    /*!
        Esse método possui a equecao a ser executada pelo fluxo
    */
    double execute() const {
...
* Está classe herda o Flow e implementa a execucao
*/
class FlowComplexF: public FlowImpl
{
public:
    /*!
        Esse é um construtor que possui atributo inicial para o fluxo
        \param name nome do fluxo.
    */
    FlowComplexF(string name, System *s, System *t): FlowImpl(name, s, t){};
...
* Está classe herda o Flow e implementa a execucao
*/
class FlowComplexG: public FlowImpl
{
public:
    /*!
        Esse é um construtor que possui atributo inicial para o fluxo
        \param name nome do fluxo.
    */
    FlowComplexG(string name, System *s, System *t): FlowImpl(name, s, t){};
...
* Está classe herda o Flow e implementa a execucao
*/
class FlowComplexT: public FlowImpl
{
public:
    /*!
        Esse é um construtor que possui atributo inicial para o fluxo
        \param name nome do fluxo.
    */
    FlowComplexT(string name, System *s, System *t): FlowImpl(name, s, t){};
...
* Está classe herda o Flow e implementa a execucao
*/
class FlowComplexR: public FlowImpl
{
public:
    /*!
        Esse é um construtor que possui atributo inicial para o fluxo
        \param name nome do fluxo.
    */
    FlowComplexR(string name, System *s, System *t): FlowImpl(name, s, t){};
...
* Está classe herda o Flow e implementa a execucao
*/
class FlowComplexU: public FlowImpl
{
public:
    /*!
        Esse é um construtor que possui atributo inicial para o fluxo
        \param name nome do fluxo.
    */
    FlowComplexU(string name, System *s, System *t): FlowImpl(name, s, t){};
...
* Está classe herda o Flow e implementa a execucao
*/
class FlowComplexV: public FlowImpl
{
public:
    /*!
        Esse é um construtor que possui atributo inicial para o fluxo
        \param name nome do fluxo.
    */
    FlowComplexV(string name, System *s, System *t): FlowImpl(name, s, t){};
